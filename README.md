...
**Combat & presentation**
- Added a cinematic boss-death sequence: hit stop, camera lunge and zoom, a shockwave ring, chromatic aberration, rotating debris, and glowing embers - synced in multiplayer
- Added off-screen boss and food arrows; the boss arrow is split into head/body halves and the old head glow is removed
- Added a reward-style post-boss **upgrade card** selection screen for Arcade runs, with auto-fit text
- Score popups now show the actual points gained (+1 / +5 / +2)
- Boss spawn gap grows quadratically as you defeat bosses (100 → 400 cap)
